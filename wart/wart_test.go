...
func TestStartErrorWithNoRedisAddress(t *testing.T) {
	_, err := Create("", "", "", "TestCluster", "TestWart", "", 3, 3, 5, false, "8787")
...
func TestStartErrorWithFailedPing(t *testing.T) {
	_, err := Create("", "bad", "", "TestCluster", "TestWart", "", 3, 3, 5, false, "8787")
...
func TestStartReturnsNilWhenSuccessful(t *testing.T) {
	mr, _ := miniredis.Run()
	_, err := Create("", mr.Addr(), "", "TestCluster", "TestWart", "", 3, 3, 5, false, "8787")
	if err != nil {
...
func TestStartHandlesScriptsPassedIn(t *testing.T) {
	...
	_, err := Create("", mr.Addr(), "", "TestCluster", "TestWart", scripts, 3, 3, 5, false, "8787")
	if err != nil {
